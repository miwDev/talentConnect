...
<?php $this->start('js') ?>
<script src="/public/assets/js/empresaLogic.js" defer></script> <!-- Para vista previa de foto, modal de subida, y toggle pass -->
<?php $this->stop() ?>
        ...
        <div class="login-contents register-contents">
            ...
            <div class="login-info-card register-avatar-card">
                ...
                <div class="avatar-upload-area">
                    <img id="vistaPrevia" src="/public/assets/images/genericCompany.svg" alt="Logo genérico" class="generic-avatar company-logo">
                </div>

                <div class="avatar-buttons">
                    <button type="button" id="botonFoto" class="login-btn avatar-btn upload-btn">Subir Logo (Elegir Archivo)</button>
                </div>
